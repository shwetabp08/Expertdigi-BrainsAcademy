...
const Gallery = () => {
  return (
    <>
    <div className="bannerPage position-relative z-4">
        <Navbar/>
        <div className="container py-5">
          <div className="row my-5 text-center align-items-center justify-content-center">
            ...
            First Adventures <span className="underline-text">Gallary!
           ...
           <p className="col-md-9 col-lg-8 col-xl-7 col-xxl-6 subheading fw-semibold">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates, explicabo accusantium nulla magnam beatae quis asperiores molestiae dicta doloremque? Commodi repellendus impedit adipisci, tenetur id aut odit culpa sit ad.
            </p>
           </div>
            </div>
